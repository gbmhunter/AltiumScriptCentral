...
' @brief    The default file name (minus extension) for the user data.
' @details  Changing this will cause any existing user data to be lost (unless
'           you renamed the file also).
...
'===================== COMPONENT DESIGNATOR DEFINITIONS ======================='

' Sorted alphabetically by designator acronym
...
' @details   All variables in here cannot be setup as constants.
